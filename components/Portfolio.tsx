...
const CATEGORIES = ['All', 'Landing Pages', 'Web Apps', 'E-commerce'];
...
export default function Portfolio() {
  ...
  return (
    <section id="portfolio" className="py-24 relative overflow-hidden bg-white border-t border-slate-50">
            ...
            {filteredProjects.map((project) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-slate-50">
                  ...
                  {/* Category badge */}
                  <span className="absolute top-4 left-4 text-[11px] font-bold tracking-widest uppercase text-secondary bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white shadow-sm">
                    {project.category}
                  </span>
                  {/* Arrow */}
