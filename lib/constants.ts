...
export const PORTFOLIO = [
  ...
  },
  {
    ...
    image: '/resumes/r1.png',
    tags: ['Resume', 'ATS', 'Career'],
    link: '/resumes/resume_1.pdf',
  },
  {
    title: 'ATS-Optimized Resume 2',
    category: 'Resume Making',
    serviceId: 'student',
    description: 'Professional ATS-friendly resume tailored for tech roles, ensuring high visibility with applicant tracking systems.',
    image: '/resumes/r2.png',
    tags: ['Resume', 'ATS', 'Career'],
    link: '/resumes/resume_2.pdf',
  },
  {
    title: 'ATS-Optimized Resume 3',
    category: 'Resume Making',
    serviceId: 'student',
    description: 'Modern, clean, and ATS-compliant resume designed to highlight your academic achievements and side projects.',
    image: '/resumes/r3.png',
    tags: ['Resume', 'ATS', 'Career'],
    link: '/resumes/resume_3.pdf',
  },
  {
    ...
    image: '/resumes/l1.png',
    tags: ['LinkedIn', 'Branding', 'Networking'],
    link: '#',
  },
  {
    title: 'GitHub Profile Building',
    ...
    image: '/resumes/g1.jpg',
    tags: ['GitHub', 'Open Source', 'Profile'],
    link: '#',
  },
  {
    title: 'College Projects Making',
    category: 'College Projects',
    serviceId: 'student',
    description: 'End-to-end guidance and development for college capstone projects, complete with documentation and real-world impact.',
    image: '/resumes/p1.jpg',
    tags: ['Projects', 'Academic', 'Development'],
    link: '#',
  },
  {
    ...
    serviceId: 'mobile',
    description: 'A comprehensive mobile dashboard for managing users, roles, and permissions on the go. Features secure authentication and real-time syncing.',
    image: '/projects/mobile project/p1.2.png',
    mobileImages: [
      '/projects/mobile project/p1.1.png',
      '/projects/mobile project/p1.2.png',
      '/projects/mobile project/p1.3.png',
    ],
    tags: ['React Native', 'Role Management', 'iOS & Android'],
    link: '#',
  },
  {
    ...
    category: 'Mobile Apps',
    serviceId: 'mobile',
    description: 'A seamless mobile shopping experience featuring product discovery, quick checkout, and order tracking across platforms.',
    image: '/projects/mobile project/p2.2.png',
    mobileImages: [
      '/projects/mobile project/p2.1.png',
      '/projects/mobile project/p2.2.png',
      '/projects/mobile project/p2.3.png',
    ],
    tags: ['Flutter', 'E-Commerce', 'iOS & Android'],
    link: '#',
  },
  {
    title: 'Healthcare Connect App',
    category: 'Mobile Apps',
    serviceId: 'mobile',
    description: 'A patient-centric mobile application designed to simplify appointment booking, access medical records, and consult with doctors.',
    image: '/projects/mobile project/p3.2.png',
    mobileImages: [
      '/projects/mobile project/p3.1.png',
      '/projects/mobile project/p3.2.png',
      '/projects/mobile project/p3.3.png',
    ],
    tags: ['Swift', 'Kotlin', 'Healthcare'],
    link: '#',
  }
];
